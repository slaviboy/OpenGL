...
/**
 * ConfigChooser for applying antialiasing for the OpenGL drawing,
 * but it might get a little bit slower, since extra calculation
 * are needed for the antialiasing to take effect.
 */
class OpenGLConfigChooser : EGLConfigChooser {
    ...
    override fun chooseConfig(egl: EGL10, display: EGLDisplay): EGLConfig? {
        ...
        if (numConfigs <= 0) {
            ...
            // converage multi sampling configuration, for the nVidia Tegra2.
